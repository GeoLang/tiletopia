//! Single-process leader election with Raft-style terms.
//!
//! Multi-node consensus (openraft) was removed as never-wired scaffolding, see
//! DESIGN_TODO "tiletopia multi-node HA" before reintroducing it.
